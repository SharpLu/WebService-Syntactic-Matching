...
public class OntologyManager {
    ...
    public HashMap<String, OWLClass> loadClasses(Reasoner reasoner) {
        HashMap<String, OWLClass> mapName_OWLClass = new HashMap<>();
    ...
    public OWLClass[] getCommon(OWLClass[] set1, OWLClass[] set2) {
        HashSet<OWLClass> set = new HashSet<>();
    ...
    public ArrayList<OWLObjectProperty> findRelationship(OWLDescription clsX, OWLDescription clsY, Reasoner reasoner) {

        ArrayList<OWLObjectProperty> relationships = new ArrayList<>();
